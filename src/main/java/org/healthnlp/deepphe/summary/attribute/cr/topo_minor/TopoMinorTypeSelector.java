 ...
 * @since {3/28/2023}
 */
public class TopoMinorTypeSelector implements AttributeInfoCollector, AttributeNormalizer {
   ...
   private String _bestCode = "9";


   static private String getTopoMajor( final Map<String,String> dependencies ) {
      final String topographyMajor = dependencies.getOrDefault( "topography_major", "" )
                                           .toUpperCase();
      if ( topographyMajor.length() > 3 ) {
         return topographyMajor.substring( 0, 3 );
      }
      return topographyMajor;
   }
   ...
   static public Supplier<AttributeNormalizer> getAttributeNormalizer( final Map<String,String> dependencies ) {
      final String topoMajor = getTopoMajor( dependencies );
      if ( topoMajor.equals( "C80" ) ) {
         return TopoMinorTypeSelector::new;
      }
