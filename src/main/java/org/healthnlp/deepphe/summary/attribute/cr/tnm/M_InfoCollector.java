 ...
 * @since {3/24/2023}
 */
public class M_InfoCollector extends AbstractAttributeInfoCollector {


   public Collection<String> getRelationTypes() {
      return Arrays.asList( RelationConstants.HAS_CLINICAL_M, RelationConstants.HAS_PATHOLOGIC_M );
   }
