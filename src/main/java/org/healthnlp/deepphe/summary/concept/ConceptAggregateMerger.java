 ...
 * @since 10/15/2020
 */
final public class ConceptAggregateMerger {

   static private final Logger LOGGER = Logger.getLogger( "ConceptAggregateMerger" );

   private ConceptAggregateMerger() {}
...
//      }
   ...
   static private Collection<ConceptAggregate> mergeTumors( final Collection<ConceptAggregate> neoplasms,
      ...
      if ( neoplasms.size() == 1 ) {
         final Collection<ConceptAggregate> candidateLocations = new ArrayList<>( neoplasms ).get( 0 ).getRelatedSites();
