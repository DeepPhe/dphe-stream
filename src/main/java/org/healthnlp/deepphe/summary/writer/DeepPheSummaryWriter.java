...
//
///**
// * This is just a copy of the EvalFileWriterXn , with human-readable heading names and comma separation instead of bsv.
// *
// * @author SPF , chip-nlp
// * @since {4/30/2021}
// */
//public class DeepPheSummaryWriter extends AbstractFileWriter<Patient> {
//
//   static private final Logger LOGGER = Logger.getLogger( "DeepPheSummaryWriter" );
//
...
//      final File cancerFile = new File( outputDir, "DiscoveredCancers.csv" );
//      final File tumorFile = new File( outputDir, "DiscoveredTumors.csv" );
//      if ( _needHeader ) {
...
//   }
//
//   static private final String CANCER_HEADER = "Patient ID,"
//                                               + "Summary ID,"
//                                               + "Summary URI,"
//                                               + "Cancer Type,"
//                                               + "Histologic Type,"
...
//         return "";
//      }
//      return patientId + "," + cancer.getId() + "," + cancer.getClassUri() + ","
...
//
//
//   static private final String TUMOR_HEADER = "Patient ID,"
//                                              + "Cancer ID,"
//                                              + "Summary ID,"
//                                              + "Summary URI,"
//                                              + "Cancer Type,"
...
//         return "";
//      }
//      return patientId + "," + cancerId + "," + tumor.getId() + "," + tumor.getClassUri() + ","
//             + tumor.getClassUri() + ","
...
//               .map( DeepPheSummaryWriter::getDiagnosisStage )
