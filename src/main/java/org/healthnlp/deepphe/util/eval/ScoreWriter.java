...
//         writer.write( "Attribute Score:\n" + getPropertyF1( corpus ) + "\n" );
         ...
         for ( EvalPatient patient : corpus.getPatients() ) {
            savePatientScore( writer, requiredNames, scoringNames, patient );
         }
   ...
   static private void savePatientScore( final Writer writer,
      ...
      for ( EvalNeoplasm pair : tp ) {
         saveTP( writer, requiredNames, scoringNames, pair );
      }
   ...
   static private void saveTP( final Writer writer,
      ...
      final EvalNeoplasmSummary gold = evalNeoplasm.getGoldSummary();
      final EvalNeoplasmSummary system = evalNeoplasm.getSystemSummary();
