...
final class EvalNeoplasmSummary implements IdOwner {
   ...
   public boolean equals( final Object other ) {
      return other instanceof EvalNeoplasmSummary && hashCode() == other.hashCode();
   }
