...
final class EvalNeoplasm extends AbstractEvalObject {
   private final EvalNeoplasmSummary _gold;
   private final EvalNeoplasmSummary _system;

   EvalNeoplasm( final EvalNeoplasmSummary gold, final EvalNeoplasmSummary system ) {
      _gold = gold;
      _system = system;
   }

   EvalNeoplasmSummary getGoldSummary() {
      return _gold;
   }

   EvalNeoplasmSummary getSystemSummary() {
      return _system;
   }
