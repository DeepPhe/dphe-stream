 ...
 * @since 3/7/2017
 */
final public class CrNonGraphedRelationFinder extends JCasAnnotator_ImplBase {
...
//Maybe for breast Ki-67
   ...
   static private final Logger LOGGER = Logger.getLogger( "CrNonGraphedRelationFinder" );
