 ...
 */
final public class CrEvalSummarizer {
...
//                          "PDL1", "MSI",
   ...
   public static void main( final String... args ) {
      ...
      final File evalDir = new File( args[ 1 ] );
      final File evalFile = new File( args[ 1 ], evalDir.getName() + ".bsv" );
//      final File evalFile = new File( args[ 1 ] + ".bsv" );
      ...
      try ( Writer evalWriter = new FileWriter( evalFile ) ) {
         ...
         for ( String attribute : EVAL_ATTRIBUTE_NAMES ) {
            ...
            evalWriter.write( attribute + "_confidence|" );
         }
         evalWriter.write( "\n" );
         evalWriter.flush();
   ...
   static private void processDoc( final File file,
      ...
      // Process doc text
      final PatientSummary summary = CrDmsRunner.getInstance()
